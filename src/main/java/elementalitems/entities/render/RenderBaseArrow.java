package elementalitems.entities.render;

import elementalitems.ElementalItems;
import elementalitems.entities.arrows.BaseEntityArrow;
...
public class RenderBaseArrow<T extends BaseEntityArrow> extends Render<T> {
	public RenderBaseArrow(RenderManager renderManagerIn) {
	...
	protected ResourceLocation getEntityTexture(T entity) {
		String base = ElementalItems.MOD_ID + ":textures/entity/arrow_";
		return new ResourceLocation(base + entity.getType().getTypeName() + ".png");
	}
